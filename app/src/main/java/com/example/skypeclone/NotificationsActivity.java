...
//    private String listUserId = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notification_list = findViewById(R.id.notification_recycleView_Id);
                                                                                                        ...
                                                                                                        if (task.isSuccessful()) {
                                                                                                            friendRequestRef.child(listUserId).child(currentUserId).removeValue()
                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                        ...
                                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                            if (task.isSuccessful()) {
                                                                                                                                Toast.makeText(NotificationsActivity.this, "New Contacts Saved.", Toast.LENGTH_SHORT).show();
                                                                                                                            }
                                                                                                                        }
                                                                                                                    });
                                                                                                        }
    ...
    public static class NotificationViewHolder extends RecyclerView.ViewHolder {
        ...
        public NotificationViewHolder(@NonNull View itemView) {
            ...
            userNameText = itemView.findViewById(R.id.name_notification_Id);
            acceptBtn = itemView.findViewById(R.id.request_accept_btn_Id);
            cancelBtn = itemView.findViewById(R.id.request_decline_btn_Id);
            profileImageView = itemView.findViewById(R.id.image_notification_Id);
