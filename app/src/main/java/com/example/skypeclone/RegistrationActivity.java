...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneText = findViewById(R.id.phoneText_Id);
        codeText = findViewById(R.id.codeText_Id);
        continueAndNextBtn = findViewById(R.id.continueNextButton_Id);
            ...
            public void onClick(View view) {
                ...
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent")) {
                    ...
                    if (verificationCode.equals("")) {
                        ...
                        PhoneAuthCredential authCredential = PhoneAuthProvider.getCredential(mVerificationId, verificationCode);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                loadingBar.dismiss();
                Toast.makeText(RegistrationActivity.this, "Code has been sent, Please check and verify...", Toast.LENGTH_SHORT).show();
